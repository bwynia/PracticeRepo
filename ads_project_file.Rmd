...
```{r}
# 
multivariable_model <- lm(taxvaluedollarcnt ~ finishedsquarefeet12 + bathroomcnt + garagecarcnt + bedroomcnt + regionidneighborhood ,na.action=na.exclude, data = home_data)
